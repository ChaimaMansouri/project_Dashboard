...
app.use('/images', express.static(path.join(__dirname, '../Front_end/images'))); // Serve static images
app.use(express.static(path.join(__dirname, '../Front_end/dist'))); // Serve static frontend files
